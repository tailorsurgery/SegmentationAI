...
# Configuración del método de inicio para multiprocessing
...
class MultiplanarDataset3D(Dataset):
    def __init__(self, image_dir, mask_dir, transform=None, limit=None, patch_size=(128, 128, 128), stride=(64, 64, 64)):
        ...
        for image_file, mask_files in self.image_mask_pairs:
            ...
            for mask_file in mask_files:
                ...
                combined_mask[mask_resized > 0] = 1  # Asignar valor 1 a los píxeles de hueso
            print(f"Máscara combinada creada con forma: {combined_mask.shape}")
    ...
    def __getitem__(self, idx):
        ...
        if self.transform:
            ...
            # Añadir dimensión de canal a la imagen y máscara
